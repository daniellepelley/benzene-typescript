 ...
 *
 * Port of Benzene.FluentValidation.ValidationClientMiddlewareBuilder, ADAPTED to Joi. C# injects the
 * `IServiceResolver` so the middleware can resolve `IValidator<TRequest>`; the Joi client middleware
