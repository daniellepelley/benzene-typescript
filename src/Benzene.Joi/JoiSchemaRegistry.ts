...
export class JoiSchemaRegistry {
  ...
  /**
   * Associates a request class with the Joi schema that validates its instances. The schema's type is
 ...
 */
export function registerJoiSchema<T>(requestType: Constructor<T>, schema: Schema<T>): void {
