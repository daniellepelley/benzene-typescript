 ...
 *
 * Port of Benzene.FluentValidation.ValidationMiddlewareBuilder, ADAPTED to Joi.
 *
 ...
 * the retired data-annotations middleware used) and looks up its Joi schema in `JoiSchemaRegistry`.
...
export class ValidationMiddlewareBuilder implements IHandlerMiddlewareBuilder {
  create<TRequest, TResponse>(
    ...
    const schema = requestType === undefined ? undefined : getJoiSchema(requestType);
