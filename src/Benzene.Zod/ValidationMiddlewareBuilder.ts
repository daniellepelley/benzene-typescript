 ...
 *
 * Port of Benzene.FluentValidation.ValidationMiddlewareBuilder, ADAPTED to Zod.
 *
 ...
 * the retired data-annotations middleware used) and looks up its Zod schema in `ZodSchemaRegistry`.
...
export class ValidationMiddlewareBuilder implements IHandlerMiddlewareBuilder {
  create<TRequest, TResponse>(
    ...
    const schema = requestType === undefined ? undefined : getZodSchema(requestType);
