/**
 * Test-event builders for the Azure Functions triggers: turn a platform-neutral `@benzenejs/testing`
 ...
 * `@azure/service-bus`, `@azure/event-hubs`), so one `@benzenejs/azure-function-testing` package with a
 ...
 * `@benzenejs/testing`) — the Azure counterpart of `buildAwsLambdaHost`: the one transport-specific line that
