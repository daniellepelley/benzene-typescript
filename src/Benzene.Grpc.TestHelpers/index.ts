/**
 * Test helpers for `@benzene/grpc`: a hand-rolled grpc-js {@link createServerUnaryCall | ServerUnaryCall}
 ...
 * `GrpcChannel`. That whole mechanism is .NET-and-ASP.NET-specific: `@benzene/grpc` deliberately replaced
