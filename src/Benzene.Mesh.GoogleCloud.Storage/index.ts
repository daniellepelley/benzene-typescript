 ...
 * Cloud analogue of `addMeshAggregatorWithS3` (`@benzenejs/mesh-aws-s3`) / `addMeshAggregatorWithBlob`
 * (`@benzenejs/mesh-azure-blob`). Adapts `Google.Cloud.Storage.V1` to the `@google-cloud/storage`
 * JS-ecosystem equivalent (the same package `@benzenejs/clients-google-cloud-pubsub` uses for its own GCP
