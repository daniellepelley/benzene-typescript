 ...
 * agnostic `@benzene/azure-function-core`. Adding the getter here — the exact `declare module` + prototype
 * pattern the `@benzene/azure-function-testing` package uses to add `buildAzureFunctionApp` to the neutral
