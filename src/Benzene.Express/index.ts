/**
 * `@benzene/express` - run Benzene inside an existing Express (or Connect) app as a piece of middleware:
 ...
 * analog of `@benzene/aws-lambda-api-gateway`'s; `benzene()` is the entry point.
 */
export * from './types';
