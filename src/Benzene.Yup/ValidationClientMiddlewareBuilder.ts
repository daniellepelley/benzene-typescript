 ...
 *
 * Port of Benzene.FluentValidation.ValidationClientMiddlewareBuilder, ADAPTED to Yup. C# injects the
 * `IServiceResolver` so the middleware can resolve `IValidator<TRequest>`; the Yup client middleware
