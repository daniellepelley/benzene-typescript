...
/**
 * Adds Yup request validation to a message router.
 *
 ...
 * ADAPTED to Yup. Registers `DefaultValidationStatusMapper` as the `IValidationStatusMapper` (via
 ...
 * implementations; the Yup equivalent of that association is `registerYupSchema`, called explicitly
...
/**
 * Client-side (outbound) counterpart of `useYupValidation`.
 *
