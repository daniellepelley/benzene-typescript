 ...
 * Benzene.FluentValidation.ValidationClientMiddleware, ADAPTED to Joi. The schema is resolved from the
...
registerJoiSchema(ClientRequest, Joi.object({ name: Joi.string().max(10) }));
